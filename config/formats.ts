...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	{
		section: "Torneio SESI",
	},
	{
		name: "[Gen 9] Teste Torneio SESI",
		desc: `Teste torneio SESI`,
		gameType: 'doubles',
		bestOfDefault: true,
		ruleset: ['Flat Rules', '!! Adjust Level = 50', 'Min Source Gen = 9', 'VGC Timer', 'Open Team Sheets', 'Best of = 3'],
		restricted: ['Restricted Legendary'],
		banlist: ['- Incineroar', '-Gholdengo', 'Kingambit', '-Archaludon', '-Pelipper', '-Porygon2', '-Amoonguss', '-Annihilape', '-Rillaboom', '-Sneasler', '- Paradox', '- Sub-Legendary', '-Sinistcha', '-Glimmora', '-Baxcalibur', '-Ursaluna', '- Ursaluna-Bloodmoon', '- Farigiraf', '- Porygon', '- Palafin', '- Orthworm', ],
	},
];
